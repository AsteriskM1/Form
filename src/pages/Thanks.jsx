    ...
    <section className="flex mobile:flex-row flex-col">
      <div className="flex mobile:flex-row flex-col">
        ...
        <div className="flex flex-col items-center mobile:mt-64 mt-52 mobile:ml-96 ml-12">
          ...
          <input type="submit" className="w-[379px] h-[53px] bg-black text-white mobile:mt-4 mt-8 rounded-lg transition duration-150 ease-in-out hover:scale-105 hover:drop-shadow-lg cursor-pointer" placeholder='Submit' />
        </div>
      </div>
    </section>
  )
